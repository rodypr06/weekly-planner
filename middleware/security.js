...
const aiPromptValidationRules = () => {
    return [
        body('prompt')
            ...
            .custom((value) => {
                // Check for dangerous script patterns instead of restrictive character matching
                const dangerousPattern = /<script|<iframe|javascript:|vbscript:|onload=|onerror=|eval\(|Function\(/i;
                if (dangerousPattern.test(value)) {
